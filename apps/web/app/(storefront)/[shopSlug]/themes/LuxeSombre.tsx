          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {produits.map(produit => (
              <Link key={produit._id} href={`/${shop.slug}/produits/${produit._id}`}
                ...
                <div className="aspect-square relative overflow-hidden" style={{ backgroundColor: t.surface }}>
                  {produit.images?.[0]
                  ...
                  {produit.comparePrice > produit.price && (
                    <div className="absolute top-3 left-3 text-xs px-2 py-1"
                         style={{ backgroundColor: t.accent, color: t.bg }}>
                  ...
                  {produit.totalStock === 0 && (
                    <div className="absolute inset-0 flex items-center justify-center"
                      ...
                      <p className="text-xs tracking-widest uppercase" style={{ color: t.muted }}>Epuise</p>
                    </div>
                  )}
                </div>
