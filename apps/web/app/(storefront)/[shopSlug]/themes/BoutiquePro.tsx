...
export default function BoutiquePro({ shop, produits }: Props) {
  ...
  return (
    <div style={{ backgroundColor: t.bg, color: t.text, minHeight: '100vh' }}>
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-xl
                         font-semibold text-sm shadow-sm transition-all hover:opacity-90"
        ...
        <div className="max-w-6xl mx-auto px-4 py-14 md:py-20">
          <div className="text-center space-y-5 max-w-2xl mx-auto">
            {shop.isVerified && (
              ...
              >
                <Sparkles size={12} />
                Boutique professionnelle certifiée
              </div>
            )}
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              <Link
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-2xl
                           font-bold text-sm shadow-md transition-all hover:opacity-90"
                style={{ backgroundColor: t.accent, color: '#fff' }}
              >
              ...
              {shop.whatsapp && (
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-2xl
                             font-bold text-sm shadow-sm transition-all hover:opacity-90"
      ...
      <div className="max-w-6xl mx-auto px-4 pb-16 space-y-6">
        ...
        {produits.length === 0 ? (
          <div className="text-center py-16" style={{ color: t.muted }}>
            ...
            <p>Produits bientôt disponibles</p>
          </div>
        ) : (
                  ...
                  {produit.comparePrice > produit.price && (
                    <div
                      className="absolute top-2 left-2 text-xs font-bold
                                 px-2.5 py-1 rounded-full shadow-sm text-white"
                      style={{ backgroundColor: t.accent }}
                    >
      ...
      {/* ── À PROPOS ── */}
      {shop.about?.description && (
        <div style={{ backgroundColor: t.elevated,
