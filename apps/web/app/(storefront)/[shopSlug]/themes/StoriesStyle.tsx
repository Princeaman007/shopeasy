    ...
    <div style={{ backgroundColor: t.bg, color: t.text, minHeight: '100vh' }}>
      ...
      >
        ...
        <div
          ...
          style={{
            background: `radial-gradient(ellipse at top right, ${t.accent}, transparent 60%)`,
          }}
        />
          ...
          <div className="max-w-xl space-y-6">
            <div
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full
                         text-xs font-bold"
              style={{
                background: `linear-gradient(135deg, ${t.accent}30, transparent)`,
      ...
      <div className="max-w-6xl mx-auto px-4 pb-16 space-y-6">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-black" style={{ color: t.text }}>
            🔥 Nouveautés
          </h2>
          <Link
            href={`/${shop.slug}/catalogue`}
        ...
        {produits.length === 0 ? (
          <div className="text-center py-16" style={{ color: t.muted }}>
            ...
            <p className="font-bold">Collection bientôt disponible 🔥</p>
          </div>
        ) : (
                ...
                <div className="aspect-square relative overflow-hidden"
                  ...
                  {produit.images?.[0]
                    ? <Image src={produit.images[0]} alt={produit.name}
                             fill className="object-cover group-hover:scale-110
                  ...
                  <div
                    className="absolute inset-0 opacity-0 group-hover:opacity-100
                               transition-opacity"
                    style={{ background: `linear-gradient(to top, ${t.accent}40, transparent)` }}
                  />
